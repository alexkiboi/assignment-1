...
// /*
 ...
 let numNeighbours2 = Number(numNeighbours);
...
// */
 ...
 if(language == "english" && population < 990000000 && isIsland != true){
...
switch(language){
    case 'chinese or mandarin':
                  console.log(`MOST number of native speakes`);
        break;
     case 'spanish':
